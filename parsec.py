...
class Parsec:
    ...
    def parsec_for_fit_build(self, x, p):
        """
        Build PARSEC airfoil following MATLAB implementation exactly.
        Parameters match MATLAB: p1->r_leup, p2->r_lelo, etc.
        """
        locc = np.argmin(x)
        xUp = x[:locc + 1]  # Include LE point
        xLow = x[locc:]     # Include LE point
        ...
        # Combine surfaces, avoiding duplicate LE point
