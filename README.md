...
-> SU2: Download Window's version at https://su2code.github.io/download.html. Add the address of the folder containing the executables (bin folder) to the system's PATH variable.

-> Microsoft MPI: Install msmpisetup.exe at https://www.microsoft.com/en-us/download/details.aspx?id=100593 . Verify that the path of the executable is stored in the system's PATH.
